...
if not is_ait_launch:
    ...
    manifest_genenerator.set_ait_source_repository('https://github.com/aistairc/Qunomon_AIT_Repository/tree/alyz_dataset_set_difference_combinatorial_coverage')
